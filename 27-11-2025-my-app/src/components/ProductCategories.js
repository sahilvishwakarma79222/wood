    ...
    <section id="product-categories" className="product-categories-section">
      ...
      <div className="product-categories-container">
        ...
        <div className="categories-header">
          ...
          {/* Description and Stats Bar removed as requested */}
        </div>
