...
// import { FiSearch, FiFilter, FiChevronRight, FiStar, FiTrendingUp } from 'react-icons/fi';
...
//     if (selectedFilter === 'budget') return category.price.includes('25,000') || category.price.includes('28,000');
//     if (selectedFilter === 'luxury') return category.price.includes('60,000') || category.price.includes('65,000');
...
//               <button
//                 key={filter.id}
//                 className={`filter-tag ${selectedFilter === filter.id ? 'active' : ''}`}
...
//               Showing <span className="count">{sortedCategories.length}</span> categories
//               {searchQuery && (
...
//                       <span className="category-type">{category.sectionTitle}</span>
...
//                           <span className="list-category-type">{category.sectionTitle}</span>
//                           {category.badge && (
//                             <span className="list-badge">{category.badge}</span>
//                           )}
//                         </div>
//                         <h3 className="list-name">{category.name}</h3>
//                         <p className="list-description">{category.description}</p>
//                       </div>
...
//                             <span>{category.rating} ({category.reviews} reviews)</span>
//                           </div>
//                           <div className="list-stat">
...
//                       <button className="list-explore-btn">
//                         View Details
//                         <FiChevronRight className="btn-arrow" />
//                       </button>
//                     </div>
...
//               Our experts can guide you to the perfect door for your space.
//               Get free consultation and quotation.
//             </p>
...
import Link from 'next/link';
import Image from 'next/image';
import { FiSearch, FiFilter, FiChevronRight, FiStar, FiTrendingUp, FiX } from 'react-icons/fi';
      ...
      <div className="modal-content" onClick={e => e.stopPropagation()}>
          ...
          <div className="modal-details">
            ...
            <div className="modal-specs">
              ...
              <div className="specs-grid">
                ...
                <div className="spec-item">
                  ...
                  <span className="spec-value">{product.rating}/5 ({product.reviews} reviews)</span>
                </div>
              </div>
            </div>
            ...
            <div className="modal-price-section">
              <div className="price-info">
                ...
                <span className="price-note">*Price may vary based on customization</span>
              </div>
              ...
              <div className="modal-actions">
                ...
                <button className="action-btn view-btn" onClick={() => window.open(product.href, '_blank')}>
                  View All Designs
                </button>
              </div>
            </div>
        ...
        <div className="modal-footer">
          <p className="footer-note">
            <strong>Note:</strong> All prices include GST. Installation charges extra based on location.
